...
h2b %>% 
  filter(case_status %in% c("CERTIFIED", "PARTIAL CERTIFIED", "DENIED")) %>%
  filter(!is.na(basic_rate_of_pay) & !(is.na(basic_unit_of_pay)), basic_unit_of_pay == "HR", basic_rate_of_pay < 100) %>%
...
We filtered out all hourly wages above 100 because we felt these were unreasonable and greatly skewed the plot.
