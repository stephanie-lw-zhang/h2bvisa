    ...
    sidebarPanel(
      selectInput(inputId = "category", label = "Categories",
                  choices = c("Case Status" = "case_status",
                              ...
                              "Difference in Prevailing and Basic Wage" = "wage_diff"),
